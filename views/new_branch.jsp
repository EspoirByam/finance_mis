             ...
             <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Branch Management</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="#!">New Branch</a>
                        </li>
        ...
        <div class="form-group row">
            ...
            <label class="col-sm-3 col-form-label" >City <span class="required">*</span>
             ...
             <div class="col-sm-9 ">                                               
                <div class="input-group">
                 <input type="text" name="city" required="required" class="form-control form-control-sm">
               </div> 
             </div>
           </div> 
         <div class="form-group row">
         ...
         <div class="form-group row">
            <label class="col-sm-3 col-form-label" >Contact <span class="required">*</span>
             ...
             <div class="col-sm-9 ">                                               
                <div class="input-group">
                 <input type="text" name="contact" required="required" class="form-control form-control-sm">
               </div> 
             </div>
           </div> 
