             ...
             <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="index.jsp?request=bank_list" title="Bank List">Bank</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="#!">New Bank </a>
                        </li>
       ...
       <div class="card">
         ...
         <form id="new_bank" method="">
             <div class="form-group row">
               ...
               <div class="form-group row">
                     <label class="col-sm-3 col-form-label">No <span class="required">*</span></label>
                     <div class="col-sm-9">
                         <input class="form-control form-control-sm" name="number" required="required">
                     </div>
                 </div>
            <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Swift-No <span class="required">*</span></label>
                  <div class="col-sm-9">
            ...
            <div class="form-group" >
               ...
               <div class="col-md-6 col-sm-12  col-sm-offset-4" style="margin-left: 35%;">                
                   ...
                   <button class="btn btn-danger btn-sm " onclick="resetFucntion()" type="button">Cancel</button>					       
...
<script type="text/javascript">
    ...
    document.getElementById("new_bank").reset();
}
</script>