<%-- 
    ...
    Created on : 8 déc. 2018, 18:06:41
    Author     : Espoir SB
--%>
        ...
        <div class="row align-items-end">
            <div class="col-lg-8 col-lg-offset-2">               
                    <div class="page-header-title">
                        <a data-toggle="modal" data-target="#user_category">
                        ...
                        <table id="order-table" class="table table-striped table-bordered nowrap table-xs">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>IT </td>                                   
                                     <td>
                                        <a href="#!" title="Update" data-toggle="modal" data-target="#update_user_category"><i class="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-blue"></i></a>
...
<div class="modal fade" tabindex="-1" id="user_category" role="dialog">
...
<div class="modal fade" tabindex="-1" id="update_user_category" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Update User Category</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
